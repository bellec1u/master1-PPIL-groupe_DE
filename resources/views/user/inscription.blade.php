        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group {!! $errors->has('email') ? 'has-error' : '' !!}">
                    <label class="col-sm-3">Adresse mail :</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group {!! $errors->has('email') ? 'has-error' : '' !!}">
                    <label class="col-sm-3">Confirmation de l'Adresse mail :</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group {!! $errors->has('password') ? 'has-error' : '' !!}">
                    <label class="col-sm-3">Mot de passe :</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group">
                    <label class="col-sm-3">Confirmation du Mot de passe :</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group {!! $errors->has('profile_image') ? 'has-error' : '' !!}">
                    <label class="col-sm-3">Image de profil :</label>
                    <div class="col-sm-7">
