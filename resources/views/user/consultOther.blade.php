...
@section('contenu')
    ...
    <article class="panel panel-info">
        ...
        <div class="panel-body">
                    ...
                    @if($user->following_allowed == true)
                <div class="row">
            ...
            @foreach($user->readings as $reading)
                <div class="row">
                    <section class="col-sm-3">
                        <p><a href="{{ URL::route('bookReturn', array('id'=>$reading->book_id))}}"><img
                                        src="{{ $reading->book->cover_url  }}" alt=""/></a></p>
                    </section>
                    <section class="col-sm-9"><br>
                        ...
                        <p><b>Date de Parution :</b> {{ date('d-m-Y', strtotime($reading->book->publication_date))  }}
                        </p>
        ...
        @foreach($user->ratings as $rating)
            <p><a href="{{ URL::route('bookReturn', array('id'=>$rating->book_id))}}"> Livre
                    : {{$rating->book->title  }}</a></p>
        ...
        @else
            <div class="row">
            <h1 align="center"> Profil privé !! </h1>
                </div>
            @endif
