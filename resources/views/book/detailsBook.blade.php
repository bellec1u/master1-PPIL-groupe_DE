            ...
            <div class="row">
                ...
                <section class="col-sm-9"><br>
                    ...
                    @if(Auth::check())
                        ...
                        ?>
                        @if($count == 0)
                            <a href="{{URL::route('addReading', array('id'=>$book->id, 'path'=>Request::url()))}}"
                               class="btn btn-primary">Ajouter à la liste de lecture</a>
                        @else
                            <a href="{{URL::route('deleteReading', array('id'=>$book->id, 'path'=>Request::url()))}}"
                               class="btn btn-danger">Supprimer de la liste de lecture</a>
                        @endif
                    @endif
                </section>
            </div>
