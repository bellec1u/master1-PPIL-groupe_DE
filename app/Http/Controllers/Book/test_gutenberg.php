...
function download_book($book_id) {
    ...
    $file_path = dirname(__FILE__).'/books/Book'.$book_id.'.epub';
    $fp = fopen($file_path, 'w+');

    $session_id = get_session_id($book_id);
    $ch = curl_init();
...
<body>
    <!--
    <a id="link" href="http://www.gutenberg.org/cache/epub/1/pg1-images.epub">Bonjour</a>
    -->
